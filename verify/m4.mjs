// M4 verification: screen-space water surface (thickness splat, bilateral blur,
// normals, refraction, Fresnel reflection) over the same pose sequence as M2.
...
try {
  ...
  const shots = [
    ['09-dots-only', { water: false, particles: true }],
    ['10-no-blur', { water: true, particles: false, blur: false }],
    ['11-no-refraction', { blur: true, refraction: false }],
    ['12-no-reflection', { refraction: true, reflection: false }],
  ];
  ...
  await setPasses({ reflection: true });
