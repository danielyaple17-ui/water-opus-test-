// Known Issue (104-cell noise) verification: Ultra pinned, 104 cells.
...
try {
  ...
  const pourPage = await newPage('?q=ultra');
  ...
  const page = await newPage('?q=ultra&pour=0');
